...
function Contact({ profile }) {
  ...
  const socialLinks = [
    { name: '抖音', icon: 'D', url: 'https://www.douyin.com/user/MS4wLjABAAAAQrS2BXoi_LMZyjFMscF85V4tYdFjWdooyw88eHOiPew?from_tab_name=main', description: profile?.douyin || '@刘琪硕' },
    { name: '邮箱', icon: '@', url: `mailto:${profile?.email || '3401049114@qq.com'}`, description: profile?.email || '3401049114@qq.com' },
  ];
      ...
      <div className="container contact__inner">
        ...
        <div className="contact__content">
          ...
          <form className="contact__form glass-card" onSubmit={handleSubmit}>
            ...
            {success && <p className="contact__form-success">消息已记录，我会尽快回复你。</p>}
          </form>
        </div>
        ...
        <footer className="contact__footer">
          <div className="contact__footer-left">
            <span className="contact__footer-logo">◆ {profile?.name || 'Portfolio'}</span>
