    ...
    return (
      <div className="admin-login">
        <div className="admin-login__card glass-card">
          ...
          <p className="admin-login__hint">后台密码：lqs1030</p>
                    ...
                    <div className="admin__list-item-body">
                      ...
                      <label className="admin__upload">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            readFile(e.target.files?.[0], (url) =>
                              updateItem('photos', photo.id, { image: url })
                            )
                          }
                        />
                      </label>
                    ...
                    <div className="admin__list-item-body admin__list-item-body--full">
                      ...
                      <label className="admin__upload">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            readFile(e.target.files?.[0], (url) =>
                              updateItem('posts', post.id, { cover: url })
                            )
                          }
                        />
                      </label>
                    ...
                    <div className="admin__list-item-body">
                      ...
                      <label className="admin__upload">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            readFile(e.target.files?.[0], (url) =>
                              updateItem('music', song.id, { cover: url })
                            )
                          }
                        />
                      </label>
                    ...
                    <div className="admin__list-item-body">
                      ...
                      <label className="admin__upload">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            readFile(e.target.files?.[0], (url) =>
                              updateItem('portfolio', item.id, { cover: url })
                            )
                          }
                        />
                      </label>
