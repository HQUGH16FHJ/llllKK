...
const defaultData = {
  ...
  music: [
    { id: 1, title: '想自由', artist: '王安宇', album: '个人播放列表', cover: '/images/photos/screenshot-1.png', url: '/music/王安宇 - 想自由.mp3' },
  ],
  posts: [
  ...
  socials: [
    { id: 1, name: '抖音', icon: 'D', url: 'https://www.douyin.com/user/MS4wLjABAAAAQrS2BXoi_LMZyjFMscF85V4tYdFjWdooyw88eHOiPew?from_tab_name=main', handle: '@刘琪硕' },
...
const LOCAL_ADMIN_PASSWORD = 'lqs1030';
